...
-- 
-- This version binds to multiple counters via name regex 
-- 
TrisulPlugin = { 

  -- id block 
  id =  {
    name = "Multi CG Listener via Regex",
  ...
  onload = function()
    print("onload: cg_monitor_3.lua context=" .. T.monitor_group_name.. " guid="..T.monitor_group_guid)
  end,
  ...
  cg_monitor  = {
	...
	-- example binds to all counters who contains host (caseinsensitive) 
	 counter_name_regex = "(?i).*(host).*",
